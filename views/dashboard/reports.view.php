  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <div id="salesReportContainer" class="report-container">
        <!-- <div class="search-filter" id="filterSelect">
          <div class="row mt-2 align-items-center">
            <div class="col-4">
              <label for="filterSelector">Select type of filter:</label>
        ...
        <div class="search-filter" id="paymentTypeFilter">
          <div class="row mt-2 align-items-center">
            <div class="col-4">
              <label for="paymentTypeSelector">Payment Type:</label>
              <select name="paymentTypeSelector" id="paymentTypeSelector"><!--onchange="filterTable('sales')" -->
        ...
        <div class="search-filter" id="dateFilter">
          <div class="row mt-2 align-items-center">
            <div class="col-4">
        ...
        <div class="row justify-content-center mb-2">
          ...
          <button class="download-btn btn btn-primary btn-block" data-report-type="sales" onclick="demoFromHTML()">Download as PDF</button>
        </div>
      </div>
      ...
      <div id="inventoryReportContainer" class="report-container">
        <div class="search-filter">
          <div class="row mt-2 align-items-center">
            <div class="col-4">
              <label for="recordTypeSelector">Payment Type:</label>
              <select name="recordTypeSelector" id="recordTypeSelector"><!--onchange="filterTable('sales')" -->
                <option value="" selected>Record Type:</option>
                <option value="Product Preparation Deduct">Product Preparation Deduct</option>
                <option value="Initial Supply">Initial Supply</option>
                <option value="Adding Supply">Adding Supply</option>
                <option value="Inventory Shrinkage">Inventory Shrinkage</option>
                <option value="Expiration Auto Deduct">Expiration Auto Deduct</option>
              </select>
            </div>
          </div>
        </div>
        <div class="search-filter">
          <div class="row align-items-center">
            <div class="col-5">
              ...
              <select id="quantityFilterInventory" name="quantityFilterInventory" class="form-control"><!--onchange="filterTable('inventory')" -->
                <option value="" selected>All</option>
                <?php foreach ($items as $option) : ?>
                  <option value="<?= $option['inventory_item'] ?>"><?= $option['inventory_item'] ?></option>
                <?php endforeach; ?>
              </select>
            </div>
          </div>
        ...
        <div class="search-filter">
          <div class="row mt-2 align-items-center">
            <div class="col-4">
              <label for="startDateInv">Start Date:</label>
              <input type="date" id="startDateInv" class="form-control">
            </div>
            <div class="col-4">
              <label for="endDateInv">End Date:</label>
              <input type="date" id="endDateInv" class="form-control">
            </div>
            <div class="col-4">
              <button onclick="searchInv()" class="btn btn-primary mt-4">Search</button>
            </div>
          </div>
        </div>
    ...
    <script>
      //filter selector for sales report
      ...
      //   const startDateSales = document.getElementById('startDateSales');
      //   const endDateSales = document.getElementById('endDateSales');
      //   const searchButton = document.querySelector('button[onclick="searchSales()"]');

      //   // Function to update the filter visibility and input state
      //   function updateFilters() {
      //     const selectedValue = filterSelector.value;

      //     if (selectedValue === 'date') {
      //       dateFilter.style.display = 'block';
      //       paymentTypeFilter.style.display = 'none';
      //       paymentTypeSelector.disabled = true;
      //       startDateSales.disabled = false;
      //       endDateSales.disabled = false;
      //       searchButton.disabled = false;
      //     } else if (selectedValue === 'payment_type') {
      //       dateFilter.style.display = 'none';
      //       paymentTypeFilter.style.display = 'block';
      //       paymentTypeSelector.disabled = false;
      //       startDateSales.disabled = true;
      //       endDateSales.disabled = true;
      ...
      //   // Listen to filterSelector changes
